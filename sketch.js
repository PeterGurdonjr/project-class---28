...
function setup() {
	...
	dground=new Ground();
	stones=new Stone(100,460,23,10);
	mango1=new Mango(600,290,34,10);
	mango2=new Mango(855,325,35,10);
	mango3=new Mango(670,260,35,10);
	mango4=new Mango(730,200,35,10);
	mango5=new Mango(710,320,36,10);
	mango6=new Mango(780,250,35,10);
	mango7=new Mango(825,170,33,10);
	mango8=new Mango(880,260,35,10);
	mango9=new Mango(940,220,35,10);
	mango10=new Mango(980,305,35,10);
